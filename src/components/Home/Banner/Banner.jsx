      ...
      <div className="banner">
        ...
        <div className="items-group">
          <div className="item-1">
            <img src="https://cdn.buttercms.com/xSKyZcPwSV6wodLr9MSH" alt="" />
            <h3>No Puppy Mills</h3>
            <span>Only Vetted Breeders</span>
          </div>
          <div className="item-1">
            <img src="https://cdn.buttercms.com/cK8fZInJTAe6ww7HVQsI" alt="" />
            <h3>Healthy Pups</h3>
            <span>10-Year Health Commitment</span>
          </div>
          <div className="item-1">
            <img src="https://cdn.buttercms.com/wfEWWqd5TTuAwwtYROth" alt="" />
            <h3>Easy, Safe Delivery</h3>
            <span>Our Private Travel Network</span>
          </div>
          <div className="item-1">
            <img src="https://cdn.buttercms.com/iLoEZ9wATx2TTRkkVtCH" alt="" />
            <h3>Trusted</h3>
